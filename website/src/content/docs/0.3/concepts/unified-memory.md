...
slug: 0.3/concepts/unified-memory
---
...
localcode recommends the most capable production-ready model whose weights fit within this budget. See [Choose a Model](/localcode/0.3/start-here/choose-a-model) for the recommended models.

## Keeping the KV cache small
