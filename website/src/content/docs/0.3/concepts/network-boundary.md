...
description: The network paths localcode can use, what triggers them, and what
  stays on your Mac by default.
slug: 0.3/concepts/network-boundary
---
...
[Permissions](/localcode/0.3/start-here/permissions) for what does and does not
prompt.
