...
slug: 0.3/guides/skills-and-hooks
---
...
You can also install skills from a URL. This fetches data from the network. See [Network Boundary](/localcode/0.3/concepts/network-boundary).
