...
## What We Have
- **Working stock binary**: `/Users/anonymized_/llama-server-stock-working`
  - Tool calling: ✅ `read_file({"path":"pyproject.toml"})` 
  - Speed: 30 tok/s on GPU, 220ms TTFT
  - Context: 4K (no TurboQuant yet)
  - Binary built from: `/Users/anonymized_/llama-cpp-test/`

- **Working TurboQuant binary**: `/Users/anonymized_/llama-cpp-turboquant/build/bin/llama-server`
  - Tool calling: ❌ broken
...
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/include/ggml.h`

### Step 2: ggml-common.h — Add block structs
- Add block_turbo4, block_turbo3, block_turbo2 structs
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/src/ggml-common.h`

### Step 3: ggml-turbo-quant.c — Core quantize/dequantize
- Copy entire file
- Add to CMakeLists.txt
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/src/ggml-turbo-quant.c`

### Step 4: ggml-cpu.c — CPU backend dispatch  
- Add turbo type cases to quantize/dequantize dispatch
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/src/ggml-cpu/ggml-cpu.c`

### Step 5: ggml-metal.metal — Metal shaders
- Add turbo4 dequant/matmul kernels
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/src/ggml-metal/ggml-metal.metal`

### Step 6: Metal dispatch (ggml-metal-ops.cpp)
- Add turbo type cases to Metal dispatch
- Source: `/Users/anonymized_/llama-cpp-turboquant/ggml/src/ggml-metal/ggml-metal-ops.cpp`

### Step 7: arg.cpp — CLI flags
- Add "turbo2", "turbo3", "turbo4" to cache type options
- Source: `/Users/anonymized_/llama-cpp-turboquant/common/arg.cpp`

### Step 8: llama-kv-cache.cpp — KV cache registration
- Register turbo types as valid KV cache formats
- Source: `/Users/anonymized_/llama-cpp-turboquant/src/llama-kv-cache.cpp`

## Server Launch Command (target)
```bash
/Users/anonymized_/llama-cpp-test/build/bin/llama-server \
...
## Important Files
- Stock build: `/Users/anonymized_/llama-cpp-test/`
- TurboQuant fork: `/Users/anonymized_/llama-cpp-turboquant/`
- Working stock binary backup: `/Users/anonymized_/llama-server-stock-working`
- LocalCode app: `/Users/anonymized_/github/gemma/`
