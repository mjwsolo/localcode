...
LLAMA_LIB = "/Users/anonymized_/llama-cpp-turboquant/build/bin/libllama.dylib"
GGML_LIB  = "/Users/anonymized_/llama-cpp-turboquant/build/bin/libggml.dylib"
MODEL_PATH = "/Users/anonymized_/.ollama/models/blobs/sha256-dc8031f1f9de58ff7e460632ab0190b4f42ff95e64669a3ea93afe09b83e0e56"
...
def restart_server():
    ...
    subprocess.Popen([
        "/Users/anonymized_/llama-cpp-turboquant/build/bin/llama-server",
        "--model", MODEL_PATH,
        "--port", "8081",
        "-ngl", "999", "--mmap",
        "-ctk", "q8_0", "-ctv", "turbo4",
