...
# old hardcoded `_MODEL_URL` constant.
_CATALOG_ENTRY = CHOICES[0]
_MODEL_URL = f"https://huggingface.co/{_CATALOG_ENTRY.hf_repo}/resolve/main/{_CATALOG_ENTRY.filename}"
