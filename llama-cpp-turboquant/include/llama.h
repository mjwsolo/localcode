...
extern "C" {
    ...
    enum llama_ftype {
        ...
        // TurboQuant (localcode fork-local) file types. Reserved block at
        // 200+ -- see the GGML_TYPE_TURBO*/TQ*_1S note in ggml.h.
        LLAMA_FTYPE_MOSTLY_TQ3_1S        = 200, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_TQ4_1S        = 201, // except 1d tensors
