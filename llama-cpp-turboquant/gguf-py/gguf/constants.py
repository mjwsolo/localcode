...
class GGMLQuantizationType(IntEnum):
    ...
    Q1_0    = 41
    Q2_0    = 42
    # TurboQuant (localcode fork-local) -- reserved block, see ggml.h
    TQ3_1S  = 67
    TQ4_1S  = 68
...
class LlamaFileType(IntEnum):
    ...
    # TurboQuant (localcode fork-local) -- reserved block, see llama.h
    MOSTLY_TQ3_1S        = 200  # except 1d tensors
    MOSTLY_TQ4_1S        = 201  # except 1d tensors
